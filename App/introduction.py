...
def introduction_page():
    ...
    """, unsafe_allow_html=True)
    st.image(normal_signal_path, caption="Example of a normal ECG signal", use_container_width=True)
    ...
    st.image(individual_signal_mitbih_path, caption="Example of an individual ECG signal from the MIT-BIH dataset", use_container_width=True)
